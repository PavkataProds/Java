...
import bg.sofia.uni.fmi.mjt.cryptowallet.Wallet;
...
public class HttpCaller {
    ...
    public static void main(String[] args) throws IOException, InterruptedException, URISyntaxException {
        ...
        //System.out.println(generateUri(null, CurrencyCode.USD));
        System.out.println(getPricesRateSync(CurrencyCode.USD));
    }
}
